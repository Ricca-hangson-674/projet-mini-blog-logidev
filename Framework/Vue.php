...
class Vue
{
     ...
     */
    public function __construct($action, $controleur = "", $parent = "front")
    {
    ...
    public function generer($donnees)
    {
        ...
        switch ($this->parent) {
            case 'auth':
                $vue = $this->genererFichier('Vue/parent-auth.php',
                    array(
                        'titre' => $this->titre, 
                        'contenu' => $contenu, 
                        'racineWeb' => $racineWeb
                ...
                break;
            case 'back':
                $vue = $this->genererFichier('Vue/parent-back.php',
                    array(
                        'titre' => $this->titre, 
                        'contenu' => $contenu, 
                        'racineWeb' => $racineWeb
            ...
            default:
                $vue = $this->genererFichier('Vue/parent-front.php',
                    array(
                        'titre' => $this->titre, 
                        'contenu' => $contenu, 
                        'racineWeb' => $racineWeb
