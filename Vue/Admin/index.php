        ...
        <table class="table table-striped table-sm">
          ...
          <?php foreach ($articles as $article):?>
            <tr>
              ...
              <td>
                <a href="<?= "adminArticle/editer/" . $this->nettoyer($article['id']) ?>" class="btn btn-secondary">Editer</a>
                <a href="<?= "adminArticle/supprimer/" . $this->nettoyer($article['id']) ?>" class="btn btn-danger">Supprimer</a>
              </td>
            </tr>
		      <?php endforeach; ?>
          </tbody>
